...
server.setRequestHandler(ListToolsRequestSchema, async () => ({
  tools: [
    ...
    {
      name: 'search_items',
      description: 'Full-text search across name, notes, item number, and all spec field values',
      inputSchema: {
        type: 'object',
        required: ['query'],
        properties: {
    ...
    },
    {
      ...
      inputSchema: {
        ...
        properties: {
          ...
          spec:        { type: 'object', description: 'Catalogue-specific fields as key/value pairs — includes manufacturer, model, type, condition, colour, barcode, status where applicable' },
        },
      },
    },
    {
          ...
          items: {
            ...
            items: {
              ...
              properties: {
                ...
                notes:      { type: 'string' },
                canContain: { type: 'boolean' },
                spec:       { type: 'object', description: 'Catalogue-specific fields — includes manufacturer, model, type, condition, colour, barcode, status where applicable' },
              },
            },
          },
        },
